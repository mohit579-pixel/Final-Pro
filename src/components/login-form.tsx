...
import { FaTeeth, FaArrowRight } from "react-icons/fa"
...
export function LoginForm({
  ...
  const handleLogin = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await dispatch(login(loginData)) as unknown as ApiResponse;
      ...
      toast.error(apiError.response?.data?.message || apiError.message || "Login failed");
    } finally {
      setLoading(false);
    }
  };
              ...
              <form className="p-6 md:p-8" onSubmit={handleLogin}>
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-cyan-500 text-transparent bg-clip-text mb-1">Welcome Back</h1>
                    <p className="text-balance text-slate-500">
                      Sign in to your DentalCare account
                    </p>
                  </div>
                  ...
                  <div className="grid gap-2">
                    <div className="flex items-center">
                      ...
                      <a
                        href="#"
                        className="ml-auto text-sm text-blue-600 hover:text-blue-500 hover:underline underline-offset-4"
                      >
                        Forgot password?
                      </a>
                    </div>
              ...
              <div className="relative hidden bg-gradient-to-br from-blue-50 to-cyan-50 md:block">
                ...
                <div className="absolute inset-0 flex items-center justify-center p-8">
                  <div className="max-w-md text-center">
                    ...
                    <h3 className="text-2xl font-bold text-slate-800 mb-3">Access Your Dental Health</h3>
                    <p className="text-slate-600 mb-6">Sign in to manage your appointments and dental treatments in one place.</p>
